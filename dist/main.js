...
const IDLE = "idle";
// actions
const SPAWN_HARVESTER = "SPAWN_HARVESTER";
const SPAWN_BUILDER = "SPAWN_BUILDER";
const SPAWN_UPGRADER = "SPAWN_UPGRADER";
function getStatus(spawnStructure) {
    return spawnStructure.spawning ? SPAWNING : IDLE;
}
function getEnergy(spawnStructure) {
    return spawnStructure.store.getCapacity("energy");
}
function getRequirementCheck(role) {
    return (context, _event) => {
...
function getCreatorAction(role, createCreep) {
    return (_context, _event) => {
        console.log(`creating creep with the role: ${role}...`);
        createCreep(role);
    };
}
function getSpawnMachine(game) {
    ...
    return createMachine({
        id: "spawnMachine",
        initial: getStatus(spawnStructure),
        context: {
